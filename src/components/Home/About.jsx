...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Great work on my Z4 in very trying circumstances, thanks to a courier not delivereing the part needed.  Simon was really helpful and did a great job on the roof electrics.  Will definitely be back!!",
    name: "Phil P",
  },
